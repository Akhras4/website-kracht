...
const digitalTransformatieData = {
    main: {
        imageSrc: digitale,
    ...
    section2: {
        ...
        description: [
            'Jij weet het, zij weten het: stilstaan is geen optie, bijblijven is niet genoeg. Het is tijd om vooruit te lopen in de digitale revolutie, in jouw markt. Maar hoe?',
    ...
    inmiddelsection: {
        ...
        subtitle: [
            'Een klantportal waarin je processen samenkomen en het makkelijker wordt voor je klant',
            'CRM',
            'Dealer portal',
            'ERP',
            'Configurator',
            'Offertetool',
            'En dat hoeft niet altijd maatwerk te zijn. Want we kunnen ook pilots draaien, live gaan met een MVP, no-code of low-code gebruiken, growth hacken... Pak het groots aan of begin heel klein.'
        ],
    },
    section2_2: {
        titlePargraf: "",
    ...
    inmiddelsection2: {
        ...
        subtitle: [
            'Sessie',
            'Applicatielandschappen en processen in kaart brengen',
            'op basis daarvan maken we een digitaliseringsroadmap',
            'Laaghangendfruit, toekomst...',
            'Zo deden we dat ook voor...',
            ''
        ],
    },
    section2_4: {
        ...
        description: [
            'Jij wilt werken aan een toekomstbestendig bedrijf en voorop lopen in de markt. Wil geen dubbele en handmatige taken meer uitvoeren, maar jouw vakmensen echt in hun kracht zetten. Klopt? Dan is een digitale transformatie jouw weg naar digital happiness.',
...
export default digitalTransformatieData;