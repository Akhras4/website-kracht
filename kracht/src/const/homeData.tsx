...
const HomeData = {
  ...
  FirstSection1: {
    titelSection: ['Jouw digital business', 'partner voor elke', 'uitdaging'],
    titelDisc: ""

  },
  FirstSection1Flexitems: [
    {
  ...
  SecondSection1Flexitems: [
    {
      imageSrc: barnd1,
      imageAlt: "barnd1",
      Heading: 'Digital business strategy',
      Paragraph: `Hoe genereer je meer verkeer, hoe krijg je meer mensen in de winkel? Hoe kunnen we in minder tijd meer omzet realiseren? Wat is je strategie en focus je op het verhogen van je omzet, of kunnen we meer resultaat halen door automatisering en optimalisering?
  ...
  secondSection1: {
    titelSection: ['de oplossing voor jouw', 'uitdagingen'],
    titelDisc: "Onze diensten gecombineerd voor de beste resultaten."
  },
  section2: {
    titlePargraf: "",
    title: 'Voor elk vraagstuk een oplossing',
    description: [
      'Ben jij klaar voor de volgende stap met jouw bedrijf? Klaar voor meer werknemers, sales, klanten? Laten we samenwerken aan je vraagstuk.',
