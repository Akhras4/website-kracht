...
const demandAndLeadGenerationData = {
    main: {
        imageSrc: Demand,
    ...
    inmiddelsection: {
        ...
        subtitle: [
            'Jouw doelgroep aantrekken en prospects omzetten in leads, dat begint bij jou. Jouw positionering en communicatie zijn van groot belang voor je zichtbaarheid, merkbekendheid en dus ook voor je leads.',
    ...
    section2: {
        ...
        description: [
            'Vergroten van zichtbaarheid en merkbekendheid;',
...
export default demandAndLeadGenerationData;