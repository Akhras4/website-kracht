...
const Buttons:React.FC<buttonsProps>=({
    ...
    return (
        ...
        <div className="flex bg-nav sw-prev absolute top-0 right-0 z-[9999] rounded-full h-fit w-fit">
         <div className="bg-inherit sw-prev rounded-b-full p-6 interactiveCursor rounded-bl-image" role="button" aria-label="Previous slide" onClick={backwardSection} >
                        ...
                        <div className="bg-inherit sw-next rounded-t-full p-6 interactiveCursor rounded-tr-image  " role="button" aria-label="Next slide" onClick={forwardSection} >
                            <svg width="8px" height="12px" xmlns="http://www.w3.org/2000/svg">
