    ...
    <>
     ...
     Als jouw digitale business partner denken wij mee van begin tot eind en geven we samen je transformatie vorm. Waarom? Om te voorkomen dat je wordt ingehaald door concurrenten of de nieuwe generatie. Om waarde toe te blijven voegen voor je collega's. Om marges te vergroten en taken te vereenvoudigen, zodat je team zich kan richten op waardevollere werkzaamheden. Én om een sterke binding en behoud van medewerkers te garanderen."
      ...
      <Section2
        ...
        description={['Jij weet het, zij weten het: stilstaan is geen optie, bijblijven is niet genoeg. Het is tijd om vooruit te lopen in de digitale revolutie, in jouw markt. Maar hoe?'
        ,'Een digitale transformatie kan leiden tot operationele efficiëntie, tot marktuitbreiding, betere klantrelaties en een sterke online aanwezigheid. Het leidt tot de kans om voorop te lopen.'
        ,'Maar hoe geef je die digitale transformatie vorm? Dat is voor elk bedrijf anders.'
  ]}
        link=''
        text=''
        direction='row'
      ...
      <Inmiddelsection
        tittlePargraph=''
        title="Voorbeelden waar we aan kunnen werken"
        subtitle='Een klantportal waarin je processen samenkomen en het makkelijker wordt voor je klant'
        subtitle1='CRM'
        subtitle2='Dealer portal'
        subtitle3='ERP'
        subtitle4='Configurator'
        subtitle5='Offertetool'
        subtitle6='En dat hoeft niet altijd maatwerk te zijn. Want we kunnen ook pilots draaien, live gaan met een MVP, no-code of low-code gebruiken, growth hacken... Pak het groots aan of begin heel klein.'
        displayType='pargraph'
      />
      ...
      />
      <Inmiddelsection
        tittlePargraph='De eerste stap naar digitale transformatie'
        title="Digitaliseringsroadmap"
        subtitle='Sessie'
        subtitle1='Applicatielandschappen en processen in kaart brengen'
        subtitle2='op basis daarvan maken we een digitaliseringsroadmap'
        subtitle3='Laaghangendfruit, toekomst...'
        subtitle4='Zo deden we dat ook voor...'
        subtitle5=''
        subtitle6=''
        displayType='list'
      />
      <Section2
        ...
        description={['Jij wilt werken aan een toekomstbestendig bedrijf en voorop lopen in de markt. Wil geen dubbele en handmatige taken meer uitvoeren, maar jouw vakmensen echt in hun kracht zetten. Klopt? Dan is een digitale tranformatie jouw weg naar digital happiness.'
